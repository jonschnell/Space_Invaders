...
public abstract class SpaceShip {
	 ...
	 * 
	 * @param deltaX a distance to move the ship in x direction
	 * @param deltaY a distance to move the ship in y direction
	 */
	 ...
	 * 
	 * @param newX the X position that the space ship should be moved to
	 * @param newy the Y position that the space ship should be moved to
	 */
